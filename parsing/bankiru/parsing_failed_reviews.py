...
reviews_to_scrape = reviews_data[reviews_data['date'] == 'HTTP ERROR'][['review_id', 'service_name']].values.tolist()

OUTPUT_CSV_PATH = 'failed_reviews_data.csv'                # Итоговый файл с данными отзывов
